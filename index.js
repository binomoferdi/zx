...
//
const BotName = 'ZX BOT'/; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/ferdinand_adiwilaga/'; // Nama Instagramlu cok
const whatsapplu = '0882-1314-0595'; // Nomor whatsapplu cok
const kapanbotaktif = 'JAM 07:00 - JAM 21:00'; // Kapan bot lu aktif
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @ferdinand_adiwilaga`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ferdinand_adiwilaga`)
})
